...
methods: {
  ...
  ()=>{this.uploadValue=100;
    ...
    await projectFirestore.collection('Subjects').doc(this.subject).get().then((response) => {
             ...
             this.allLastQuestions=response.data().modelLastQuestion
...
// await projectFirestore.collection('Subjects').doc(this.subject).update({modelLastQuestion:this.allLastQuestions})
await projectFirestore.collection('Subjects').doc(this.subject).update({modelLastQuestion:this.allLastQuestions}).catch((e) =>{
  console.log(e)
   projectFirestore.collection('Subjects').doc(this.subject).set({modelLastQuestion:this.allLastQuestions})
})
    ...
    let newQuestion = {
      ...
      console.log(this.subtopic)
    projectFirestore.collection('Subjects').doc(this.subject).collection(this.subtopic.toString()+'_Model Paper').doc('QuestionNumber_'+this.questionid).set(newQuestion)
